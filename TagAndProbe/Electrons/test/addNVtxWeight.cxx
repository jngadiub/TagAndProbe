...
void addNVtxWeight(TString treeName="GsfElectronToTrigger", TString cut = "") { //, TString cut="(tag_IsoMu24_eta2p1 || tag_IsoMu24) && tag_combRelIso < 0.15") {
    ...
    c1->cd(2);
    tMC.Draw("event_nPV>>hMC(100,-0.5,99.5)", cut);
    c1->Print("nVtx.png");
    ...
    tOut->Branch("PUweight", &weight, "PUweight/F");
