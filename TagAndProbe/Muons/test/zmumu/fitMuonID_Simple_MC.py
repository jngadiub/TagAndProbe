...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ## Input, output 
    InputFileNames = cms.vstring( 'tnpZ_MC_withHighPTID.root'
    ...
    Efficiencies = cms.PSet(
		...
		abseta = cms.vdouble(0.,2.1),
                #pt     = cms.vdouble( 10, 20, 30, 40, 45, 50, 60, 90, 140, 500 ),
...
process.TnP_Muon_ID.WeightVariable = cms.string("weight")
